SELECT T2.seller_id,
        ...
        MIN( CAST(julianday('2018-06-01') - julianday(T1.order_approved_at) AS INT) ) AS qntde_dias_ult_venda,
        MAX( CAST(julianday( '2018-06-01' ) - julianday ( dt_inicio) AS INT ) ) AS qntd_dias_base
